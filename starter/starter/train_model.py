...
Author: EK
Date: 15 Nov 2023
Details of the script: This script
...
path_wd = r'../data/'
data = pd.read_csv(os.path.join(path_wd,r'census.csv'))
# Optional enhancement, use K-fold cross validation instead of a train-test split.
train, test = train_test_split(data, test_size=0.20,random_state=3,\
